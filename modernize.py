...
s1 = ['Veille-je,ou si je dors ? Dieux je ne puis penser', "Que mon frere ait jamais eu dessein d'offencer", "Un amy que j'estime à l'esgal de moy-mesme :", "Mon frere,vous devez aymer celuy que j'ayme ;", "Que j'en sçache la cause."]
...
if __name__ == "__main__":
    ...
    # dama = open("DamaDuende Alignement.csv", "r", encoding='utf8')
