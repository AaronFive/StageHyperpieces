...
genres = ["tragedie", "comedie", "tragicomedie", "tragi-comedie"] # TODO
...
def get_dates(playText):
   ...
   for l in list(map(lambda l: l.replace("<span style=\"letter-spacing:-.3pt\">", "").replace("\xa0", ' ').replace('<a href="#_ftn1" name="_ftnref1" title="" id="_ftnref1">[1]</a>', '').strip('\n'), playText)):
...
def write_end_header(outputFile):
   outputFile.writelines("""
            </sourceDesc>
      </fileDesc>
      <profileDesc>
         ...
         <textClass>
         <keywords>
            <term subtype="genre" type="genre">Genre</term>
         </keywords>
         </textClass>
      </profileDesc>
   </teiHeader>""")
